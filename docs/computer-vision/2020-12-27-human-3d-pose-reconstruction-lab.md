...
<img src="{{ site.url_imgs }}/pose/keypoints.gif " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/pose/relative_pose.gif " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/pose/camera_matrix.png " class=".px-8" style="width: 100%">
###### camera matrix
...
<img src="{{ site.url_imgs }}/pose/log.png " class=".px-8" style="width: 100%">
###### camera matrix
