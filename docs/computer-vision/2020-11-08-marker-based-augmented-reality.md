...
<img src="{{ site.url_imgs }}/mbar/trackbars.png " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/sift_kp_less_light.png " class=".px-8" style="width: 100%">
###### SIFT keypoints with simple detail sample under light environment



<img src="{{ site.url_imgs }}/mbar/sift_kp_rich_light.png " class=".px-8" style="width: 100%">
###### SIFT keypoints with rich detail sample under light environment



<img src="{{ site.url_imgs }}/mbar/perf_sample_rich_dark_kp.png " class=".px-8" style="width: 100%">
###### performance comparison with rich detail sample under dark environment



<img src="{{ site.url_imgs }}/mbar/perf_sample_simple_dark_kp.png " class=".px-8" style="width: 100%">
###### performance comparison with simple detail sample under dark environment



<img src="{{ site.url_imgs }}/mbar/perf_sample_rich_light_kp.png " class=".px-8" style="width: 100%">
###### performance comparison with rich detail sample under light environment



<img src="{{ site.url_imgs }}/mbar/perf_sample_simple_light_kp.png " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/perf_match_akaze_light.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/AKAZE.gif " class=".px-8" style="width: 100%">
###### AKAZE performance with default parameters



<img src="{{ site.url_imgs }}/mbar/perf_match_brisk_light.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/BRISK.gif " class=".px-8" style="width: 100%">
###### BRISK performance with default parameters



<img src="{{ site.url_imgs }}/mbar/perf_match_orb_light.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/ORB.gif " class=".px-8" style="width: 100%">
###### ORB performance with default parameters



<img src="{{ site.url_imgs }}/mbar/perf_match_sift_light.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/SIFT.gif " class=".px-8" style="width: 100%">
###### SIFT performance with default parameters



<img src="{{ site.url_imgs }}/mbar/perf_match_surf_light.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/SURF.gif " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/surf_default_100_4_3.png " class=".px-8" style="width: 100%">
###### SURF defaut parameters



<img src="{{ site.url_imgs }}/mbar/surf_500_4_3.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/surf_1200_4_3.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/surf_1200_4_2.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/surf_1200_3_3.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/SURF_jittering.gif " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/sift_default_0_3_4_10_16.png " class=".px-8" style="width: 100%">
###### SIFT defaut parameters



<img src="{{ site.url_imgs }}/mbar/SIFT_stable.gif " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/sift_0_3_4_10_12.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/sift_0_3_8_10_16.png " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/brisk_default_30_3_10.png " class=".px-8" style="width: 100%">
###### BRISK defaut parameters



<img src="{{ site.url_imgs }}/mbar/brisk_15_3_10.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/brisk_15_4_10.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/BRISK_stable.gif " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/sift_flann.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/sift_bfl2_false.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/sift_bfl2_true.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/brisk_bfl2_false.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/brisk_bfhamming_false.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/brisk_bfhamming_true.png " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/sift_bfl2_score.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/sift_bfl2_knn.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/sift_flann_score.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/sift_flann_knn.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/brisk_bfhamming_score.png " class=".px-8" style="width: 100%">



<img src="{{ site.url_imgs }}/mbar/brisk_bfhamming_knn.png " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/final_default_parameters.png " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/final_computation_time.png " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/BRISK_motion.gif " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/BRISK_light.gif " class=".px-8" style="width: 100%">
...
<img src="{{ site.url_imgs }}/mbar/without_prep.png " class=".px-8" style="width: 100%">
###### without CLAHE preprocessing



<img src="{{ site.url_imgs }}/mbar/with_prep.png " class=".px-8" style="width: 100%">
