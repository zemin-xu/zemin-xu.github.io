<?php $show_gallery_video = arnold_get_post_meta(get_the_ID(), 'theme_meta_show_gallery_video');
if($show_gallery_video){
	$video_embeded_code = arnold_get_post_meta(get_the_ID(), 'theme_meta_gallery_video_embeded_code');
	$video_ratio        = arnold_get_post_meta(get_the_ID(), 'theme_meta_gallery_video_ratio');
	$video_custom_ratio = arnold_get_post_meta(get_the_ID(), 'theme_meta_gallery_video_custom_ratio');
	...
	$video_custom = $video_custom_ratio ? 'padding-top:'.($key_2 / $key_1) * 100 .'%' : false;
