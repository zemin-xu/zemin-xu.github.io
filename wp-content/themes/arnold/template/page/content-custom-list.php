...
$show_tags = arnold_get_post_meta(get_the_ID(), 'theme_meta_page_show_tags');
...
?>
<div class="cusl-style-list <?php echo sanitize_html_class($page_pagination_class); ?>" <?php echo balanceTags($page_pagination_tag); ?>>
