...
As we can see in the sketches below, I would like to attach a mini-radar covering a range of about 10m. It can work with the HMD to detect the conversation in this range and filter with keyword.
