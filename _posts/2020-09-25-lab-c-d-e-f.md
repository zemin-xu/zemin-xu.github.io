...
We can find that at the beginning, the mean of reward is either negative or zero. After about one million steps, the training situation is greatly improved. The animation below shows the training result at an intermediare stage.
