...
You can also find the source code of this project [here](https://github.com/zemin-xu/Hummingbirds) in which you will know how it is organized. You will also find a fully-trained hummingbird in the video below.
...
[Upgrading config doc](https://github.com/Unity-Technologies/ml-agents/blob/release_3_docs/docs/Migrating.md)
